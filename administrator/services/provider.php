...
return new class implements ServiceProviderInterface
{
	...
	public function register(Container $container)
	{
		...
		$container->registerServiceProvider(new ComponentDispatcherFactory('\\Aesirxbi\\Component\\Aesirx_bi'));
		...
		$container->set(
			...
			{
				$component = new Aesirx_biComponent($container->get(ComponentDispatcherFactoryInterface::class));
